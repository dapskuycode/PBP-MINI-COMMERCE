    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="mb-8">
            <div class="bg-white rounded-xl shadow-md p-6">
                ...
                <div class="mt-3 text-sm text-gray-500 bg-blue-50 p-3 rounded-lg">
                    <strong>Catatan:</strong> Sebagai admin, Anda hanya dapat mengakses area manajemen. Halaman seperti beranda, produk customer, keranjang belanja, dan checkout tidak dapat diakses.
                </div>
            </div>
        </div>
