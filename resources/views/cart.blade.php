...
<head>
  ...
  <title>Keranjang - TumbasLek Mini Commerce</title>
...
<body class="bg-gray-50 text-gray-800">
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    <section class="grid lg:grid-cols-3 gap-6">
      {{-- Kolom kiri: Daftar item atau tampilan kosong --}}
              ...
              <div class="flex-1">
                <div class="flex items-start justify-between gap-3">
                  ...
                  <div class="text-right">
                    <p class="font-semibold text-gray-900" data-product-price="{{ $item->product ? $item->product->price : 0 }}">
                      {{ $item->product ? rupiah_fmt($item->product->price) : 'Rp 0' }}
                    </p>
                    <p class="text-xs text-gray-400">/ item</p>
                    <p class="text-sm font-medium text-emerald-600 mt-1" data-item-total>
                      Total: {{ $item->product ? rupiah_fmt($item->product->price * $item->quantity) : 'Rp 0' }}
                    </p>
                  </div>
                </div>
      ...
      {{-- Kolom kanan: Ringkasan selalu muncul --}}
